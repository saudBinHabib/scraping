    ...
    def read_csv_file(self):
        ...
        try:
            for data_file in csv_files:
                ...
                columns_name = [
                    "col_" + str(counter) for counter in range(df_sub.shape[1])
                ]
...
if __name__ == "__main__":
    ...
    events_data_url = [
        url_tuple.urls for url_tuple in tuples if "gkg" in url_tuple.urls
    ][0]
